...
import Registration_test_jurai_ptlk as Registration
...
class PointCloudProcessor:
	...
	def process_point_cloud(self):
		...
		measured_pcd = measured_pcd.voxel_down_sample(voxel_size)
		# テンプレート点群とソース点群の表示
	...
	def publish_transform(self, est_T_cheese):
		...
		# 変換行列をTransformに変換
		transform_matrix = est_T_cheese.cpu().detach().numpy()[0]
