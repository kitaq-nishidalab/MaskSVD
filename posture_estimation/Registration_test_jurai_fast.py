...
class ICP:
	...
	def __call__(self, template, source):
		...
		voxel_size = 0.007 #　T：0.007　　， L：  0.008
		...
		result_fgr = Global_optimizer_fast.execute_fast_global_registration(source_down, template_down, source_fpfh, template_fpfh, voxel_size)
		...
		#print(np.linalg.det(est_R))
		#if np.linalg.det(est_R) < 0:
