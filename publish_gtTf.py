...
class TransformPublisher:
    def __init__(self):
        rospy.init_node('Publish_GTTF', anonymous=True)
        ...
        self.transforms = [
            {
                "child_frame_id": "PatternA",
                "translation": (0.1, -0.05, 0.32),
                "rotation": rpy_to_quaternion(roll=0, pitch=0, yaw=235),
            },
            {
                "child_frame_id": "PatternB",
                "translation": (0.05, 0.05, 0.325),
                "rotation": rpy_to_quaternion(roll=10, pitch=0, yaw=45),
            },
            {
                "child_frame_id": "PatternC",
                "translation": (-0.188, 0.073, 0.335),
                "rotation": rpy_to_quaternion(roll=0, pitch=0, yaw=155),
            }
        ]
