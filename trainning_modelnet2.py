...
parser.add_argument("--save_path", "-s", type=str, default="checkpoint/model_epoch300_45deg_shins2.pth", help="Path to save the trained model")
...
#-- ネットワークの定義 --
###################################
#checkpoint = torch.load("checkpoint/model_epoch500_45deg.pth")
